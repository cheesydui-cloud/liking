...
func (s *Server) Router() http.Handler {
	...
	r.Group(func(r chi.Router) {
		...
		r.Post("/api/me/rotate-sub", s.handleRotateMeSub)
		...
		r.Group(func(r chi.Router) {
			...
			r.Post("/api/servers/{id}/push-nft", s.handlePushNft)
			...
			r.Post("/api/inbounds/{id}/listen-probe", s.handleListenProbe)
			...
			r.Post("/api/users/batch", s.handleBatchUsers)
			...
			r.Post("/api/users/{id}/kick", s.handleKickUser)
